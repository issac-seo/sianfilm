...
export const PACKAGES_2026: Pkg[] = [
    {
        ...
        summaryPoints: [
        "디지털 원본 전체 + 아이폰스냅",
        <>원본 모두 제공 + 세부보정본 <strong className="font-bold text-pink-600">30장</strong> + 분할 5컷</>,
    ...
    },
    {
        ...
        featured: true,
        summaryPoints: [
        <>원본 모두 제공 + 세부보정본 <strong className="font-bold text-pink-600">20장</strong> + 분할 3컷</>,
    ...
    },
    {
        ...
        summaryPoints: [
        <>원본 모두 제공 + 세부보정본 <strong className="font-bold text-pink-600">10장</strong> + 분할 2컷</>,
        "무료 대여 소품, 조화 부케 포함",
        ],
        details: [
            "보정본: 셀렉일부터 2주 이내 제공",
