...
export const FAQS: QA[] = [
  ...
  },
  {
    ...
    a: (
      <>
        셀렉일로부터 2-4주 뒤 보정본을 받아보실 수 있기 때문에 늦어도 본식 4개월 전에는
        촬영하시는 걸 추천드립니다.<br />
        여유가 있으시다면 더 미리 일정을 잡아주세요 :)
      </>
    ),
  },
  { q: "로우파일 제공하나요?", a: "로우 파일은 제공하지 않습니다." },
  {
    ...
    a: (
      <>
        ...
        폭우나 강풍으로 촬영이 불가할 정도의 비가 올 경우 작가 스케줄에 따라 촬영일을 변경해 드리고 있습니다.
      </>
    ),
  },
  {
    q: "파란 하늘이나 윤슬에서 촬영하고 싶어요! 가능한가요?",
    a: (
      <>
        파란 하늘과 윤슬은 맑은 날에만 가능해서 장담할 수 없습니다.<br />
        윤슬은 맑은 날에도 구름이 많아 가려지면 안 보일 수도 있구요.<br />
        변수가 많은 야외 촬영이다보니 확답을 드리기가 어려워요😂<br />
        흐린 날 하늘 컷에서 하늘 합성이 가능하긴 하나 부자연스러워서 합성은 진행하지 않습니다.
      </>
    ),
  },
  {
  ...
  },
  {
    ...
    a: (
      <>
        베이직의 경우 한 장소, 가까운 곳이라면 두 장소<br />
        프리미엄은 두 장소, 가까운 거리라면 세 장소까지 가능합니다.<br />
        5시간 동안 세 장소, 세 착장하시면 환복, 이동시간이 생각보다 꽤 소요되어 컷 수가 많이 줄어듭니다.<br />
        상담을 통해 장소에 따라 5시간 그대로 진행 혹은 시간 추가 안내 도와드리겠습니다.
      </>
    ),
  },
  {
    ...
    a: (
      <>
        ...
        🌙 야간: 동작대교<br />
        🏢 렌탈 스튜디오: 키노스튜디오, <strong className="bg-amber-200">호벤스튜디오</strong>, <strong className="bg-amber-200">브릭스스튜디오</strong>
        <br />
        <br />
        *공원/들판은 노을공원에서만 진행됩니다.<br />
        서울숲, 올림픽공원, 용산가족공원 등은 관광객과 교통체증으로 인해 추천드리지 않습니다.
      </>
    ),
  },
  {
