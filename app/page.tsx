...
function ReservationSection() {
  ...
  return (
    <section className="mx-auto max-w-6xl px-4 py-4 min-h-[calc(100vh-56px)]">
...
function ReservationIntro({
  ...
  return (
    <div className="mt-8 grid gap-4 md:grid-cols-2 md:items-end">
      {/* LEFT: 가로 사진 + 큰 문구 */}
      <div>
        {/* ✅ Product 같은 카드 스타일 + hover + blur-up */}
        <div
          className={clsx(
        ...
        <h3
          className={clsx(
            titleFont.className,
            "mt-8 ml-4 text-2xl sm:text-3xl md:text-4xl leading-[1.1] text-neutral-800",
            enter("0ms")
          )}
      ...
      <div className="md:justify-self-end">
        ...
        <p
          className={clsx(
            "mt-5 ml-4 max-w-[380px] text-xs sm:text-sm text-neutral-700 leading-relaxed",
            enter("0ms")
          )}
          style={{ transitionDelay: "260ms" }}
        >
